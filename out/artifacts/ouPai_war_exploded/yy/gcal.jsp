...
<div class="container-fluid investor_relations01" align="center">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
            <h2 id="h2s" style="padding-top: 25%;padding-bottom: 2%;color: black;">工程案例</h2>
f
    ...
    <div class="row">
        <div class="hza">
            ...
            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 ">
                ...
                <span style="font-size: 20px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;宜程作为国内最早为房地产楼盘配套整体橱柜的企业之一，并率先荣获“国家康居住宅示范工程指定产品”称号。2003年至今，
                ...
                <span style="font-size: 20px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;除了与百强房企建立稳固的合作关系外，宜程的工程市场战略布局还不断延伸，瞄准城镇化发展时机，与地方的标杆企业逐步建立长期战略合作关系，
                    引导地方房企建立整体厨房标准和精装标准，由“价格营销”转变为“价值营销”，而宜程也顺利进入三四线城市这个更广阔的市场，
                    工程覆盖规模得到有效扩张！</span><br><br>
            </div>
            <div class="col-lg-1 col-md-1 col-sm-0 col-xs-0 "></div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 "
                 style="background: url('../yy_img/20161013171938_772.jpg') no-repeat; background-size: 100%, 100%;padding-top: 45%;"></div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 "
                 style="background: url('../yy_img/20161013171952_507.jpg') no-repeat; background-size: 100%, 100%;padding-top: 45%;"></div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 "
                 style="background: url('../yy_img/20161013172018_316.jpg') no-repeat; background-size: 100%, 100%;padding-top: 45%;"></div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 "
                 style="background: url('../yy_img/20161013172033_149.jpg') no-repeat; background-size: 100%, 100%;padding-top: 45%;"></div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 "
                 style="background: rgba(210,179,255,0.36);padding: 50px 30px;text-align: center">
                <div class="col-lg-1 col-md-1 "></div>
