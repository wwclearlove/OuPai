...
<<<<<<< HEAD
  ...
  <section class="container-fluid">
    <div class="row rs-1">
      ...
      <div class="col-xs-2 col-md-1 col-md-offset-5 col-xs-offset-4 fwln"><a href="${pageContext.request.contextPath}/Wefuwu/4sfw.jsp" style="text-decoration: none;color: #0f0f0f">4S服务</a></div>
      <div class="col-xs-2 col-md-1 bxzc">保修政策</div>
    </div>
    <div class="row rs-1">
      <div class="col-md-10 col-xs-10 col-md-offset-1 col-xs-offset-1 "><img src="../image/baoxiu-1.jpg" class="img-responsive" alt=""/></div>
    </div>
    <div class="row">
      <div class="col-md-10 col-xs-10 col-md-offset-1 col-xs-offset-1 ">
        <p style="font-size: 1.8em;font-weight: bold"><img src="../image/Gone.jpg" alt=""/>&nbsp;&nbsp;&nbsp;橱柜产品</p>
        <p>①.橱柜和台面部分保修期为5年；</p>
    ...
    <div class="row rs-1">
      <div class="col-md-10 col-xs-10 col-md-offset-1 col-xs-offset-1 ">
        <p style="font-size: 1.8em;font-weight: bold"><img src="../image/Gtwo.jpg" alt=""/>&nbsp;&nbsp;&nbsp;家具产品</p>
    ...
    <div class="row rs-1">
      <div class="col-md-10 col-xs-10 col-md-offset-1 col-xs-offset-1 ">
        <p style="font-size: 1.8em;font-weight: bold"><img src="../image/Gthree.jpg" alt=""/>&nbsp;&nbsp;&nbsp;欧铂尼木门 </p>
    ...
    <div class="row rs-1">
      <div class="col-md-10 col-xs-10 col-md-offset-1 col-xs-offset-1 ">
        <p style="font-size: 1.8em;font-weight: bold"><img src="../image/Gfour.jpg" alt=""/>&nbsp;&nbsp;&nbsp;卫浴产品 </p>
    ...
    <div class="row rs-1">
      <div class="col-md-10 col-xs-10 col-md-offset-1 col-xs-offset-1 ">
        <p style="font-size: 1.8em;font-weight: bold"><img src="../image/Gfive.jpg" alt=""/>&nbsp;&nbsp;&nbsp;寝具产品 </p>
        <p>软床类保修5年，床垫的床芯、弹簧保修10年，塑胶料功能配件保修1年。</p>
      </div>
    </div>
    <div class="row rs-1">
      <div class="col-md-10 col-xs-10 col-md-offset-1 col-xs-offset-1 ">
        <p style="font-size: 1.8em;font-weight: bold"><img src="../image/Gsix.jpg" alt=""/>&nbsp;&nbsp;&nbsp;壁纸产品 </p>
        <p>欧派壁纸两年免费保修，终身维护。</p>
      </div>
    </div>
  </section>
