...
<<<<<<< HEAD
  ...
  <section class="container-fluid">
    <div class="row rs-1">
      ...
      <div class="col-xs-4 col-md-4 col-md-offset-1 col-xs-offset-1"style="padding: 0;margin-top: 3%"><img src="../image/cf/three-3.png" class="img-responsive"width="100%"/>
    ...
    <div class="row rs-1">
      <div class="col-xs-4 col-md-4 col-md-offset-1 col-xs-offset-1"><img src="../image/cf/big-two.jpg" class="img-responsive"/></div>
      <div class="col-xs-6 col-md-6 zgxl-text"style="margin-left: 5%">
        <h3 style="color: #666666;margin-top: 5%">尊贵系列</h3>
...
>>>>>>> 25b9b0020c86bdb845926439d00f2ab703a39b0f
        </div>
    </div>
    <section class="container-fluid">
        <div class="row rs-1">
