...
<html>
  ...
  <section class="container-fluid">
    ...
    <div class="row rs-1">
      ...
      <div class="col-md-5" style="padding: 0;margin: 0;"><img src="../image/4S-4S.jpg" width="100%"/></div>
    </div>
    <div class="row">
      <div class="col-md-5 col-md-offset-1"style="padding: 0"><img src="../image/4S-world.jpg"width="100%"/></div>
    ...
    <div class="row">
      ...
      <div class="col-md-5" style="padding: 0;margin: 0;"><img src="../image/4S-people.jpg" width="100%"/></div>
    </div>
    <div class="row">
      <div class="col-md-5 col-md-offset-1"style="padding: 0;"><img src="../image/4S-listen.jpg" width="100%"/></div>
      <div class="col-md-5 text-4s">
