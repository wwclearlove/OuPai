        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
            ...
            <div id="the_title_content" align="center"
                ...
                <ul id="the_title_content_ul">
                    <li><a href="${pageContext.request.contextPath}/ws/our_company.jsp"><i
                            class="fa fa-dot-circle-o fa-lg"></i>公司</a></li>

                    <li><a href="${pageContext.request.contextPath}/yy/gyop.jsp"><i
                            class="fa fa-dot-circle-o fa-lg"></i> 关于宜程</a></li>
    ...
    <div class="row" style="padding-bottom: 5%;">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  hzzz">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 hzza">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 span1"
                     style="color: #ffff00; text-align: center">1994
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 span2"
                     style=" text-align: center">宜程第一套橱柜诞生，开始改变中国人对厨房的认知
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 visible-lg-block" style="margin-top: 30px;">
                    <ul style=" color: yellow ;">
                        <li><span style=" color: #000000">广州康洁厨柜企业有限公司成立（“康洁”为“宜程”注册前所用商标），率先将欧洲“整体厨房”概念引入中国。</span>
                        </li>
                        <li><span style=" color: #000000">宜程第一套整体橱柜诞生，开创中国工业化生产现代橱柜的先河，掀起中国“厨房革命”风暴。</span></li>
                        <li><span style=" color: #000000">中国第一家橱柜专营店“康洁橱柜五羊商场”开业。</span></li>
                    </ul>
                </div>
            </div>

            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 hzzb">
                <img src="../yy_img/20161107182611_996.png" class="img-responsive" alt="">
            </div>
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  hzzz">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 hzza">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 span1"
                     style="color: #ffff00; text-align: center">1995
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 span2"
                     style=" text-align: center">宜程第一套橱柜诞生，开始改变中国人对厨房的认知
                </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  hzzz">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 hzza">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 span1"
                     style="color: #ffff00; text-align: center">1996
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 span2"
                     style=" text-align: center">宜程第一套橱柜诞生，开始改变中国人对厨房的认知
                </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  hzzz">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 hzza">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 span1"
                     style="color: #ffff00; text-align: center">1997
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 span2"
                     style=" text-align: center">宜程第一套橱柜诞生，开始改变中国人对厨房的认知
                </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  hzzz">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 hzza">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 span1"
                     style="color: #ffff00; text-align: center">1998
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 span2"
                     style=" text-align: center">宜程第一套橱柜诞生，开始改变中国人对厨房的认知
                </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  hzzz">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 hzza">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 span1"
                     style="color: #ffff00; text-align: center">1999
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 span2"
                     style=" text-align: center">宜程第一套橱柜诞生，开始改变中国人对厨房的认知
                </div>
