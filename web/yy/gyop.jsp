...
<div class="container-fluid investor_relations01" align="center">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
            <h2 id="h2s" style="padding-top: 25%;padding-bottom: 2%;color: white;">关于宜程</h2>
            ...
            <div id="the_title_content" align="center"
                ...
                <ul id="the_title_content_ul">
                    ...
                    <li><a href="${pageContext.request.contextPath}/yy/ppls.jsp"><i
                            class="fa fa-dot-circle-o fa-lg"></i>品牌历史</a></li>
...
<div class="container">
    <div class="img_text">
        ...
        <div class="row" style="padding-top: 5%;padding-bottom: 5%;">
            <p class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="color:rgba(15,15,15,0.71)">&nbsp;&nbsp;&nbsp;&nbsp;
                宜程家居集团股份有限公司创立于1994年，股票代码603833，是中国家居知名品牌，拥有国际化家居产品制造基地。
                宜程以整体橱柜为龙头，带动相关产业发展，包括全屋定制、衣柜、卫浴、<br>木门、墙饰壁纸、厨房电器、寝具等，
                形成多元化产业格局 ，是国内综合型的现代整体家居一体化服务供应商。
            </p>
        </div>
    </div>
</div>
